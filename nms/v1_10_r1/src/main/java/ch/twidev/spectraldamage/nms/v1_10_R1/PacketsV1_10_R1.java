package ch.twidev.spectraldamage.nms.v1_10_R1;
...
public class PacketsV1_10_R1 implements IPackets {
    @Override
    ...
    public Entity spawnHologram(Location location, double damage, String format, Plugin plugin) {
        EntityArmorStand armorStand = this.createEntity(location, format);
        Class<?> nmsStandClass = net.minecraft.server.v1_10_R1.Entity.class;
        try {
