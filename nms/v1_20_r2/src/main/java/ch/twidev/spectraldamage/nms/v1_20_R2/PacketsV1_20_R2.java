package ch.twidev.spectraldamage.nms.v1_20_R2;
...
public class PacketsV1_20_R2 implements IPackets {
    @Override
    ...
    public org.bukkit.entity.Entity spawnHologram(Location location, double damage, String format, Plugin plugin, boolean gravity) {
        ...
        armorStand.dL().addFreshEntity(armorStand, CreatureSpawnEvent.SpawnReason.CUSTOM);
        return armorStand.getBukkitEntity();
    }
