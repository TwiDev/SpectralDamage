package ch.twidev.spectraldamage.nms.v1_13_R2;
...
public class PacketsV1_13_R2 implements IPackets {
    @Override
    ...
    public Entity spawnHologram(Location location, double damage, String format, Plugin plugin, boolean gravity) {
        ...
        Class<?> nmsStandClass = net.minecraft.server.v1_13_R2.Entity.class;
        try {
